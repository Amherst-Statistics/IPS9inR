...
We will get some tables that summarize the information displayed in Example 9.1. We can use the `tally()` function for this.
...
Now take look at Example 9.2 on page 526. To recreate that table of counts we simply have to call the `tally()` function and it will make the 2-way table for us. 
...
We continue with Example 9.9 on page 537. 
