...
Another useful function that is related to this xpbinom(), which can be used to ... 
XX 
...
Below is the code to generate a probability histogram for the distribution of the number of 
heads in four tosses of a coin Figure 4.7 (page 239): 
```{r}
## XX Pick up from here
```
