...
XX "One approach to the analysis of these data indicates that a pattern as clustered or more clustered  than this would only happen 4% of the time if the data were at random"
XX I'm unsure how to replicate this.
...
z <- z.test(c(15.84,15.33,15.58), 15, 0.25)
...
z.confint(c(15.84,15.33,15.58), 15, 0.25)
```
